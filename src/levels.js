...
//
//   'cargo'      — drifting container, destroy for bonus coins
...
export const LEVELS = [
...

  {
    ...
    spawn: [
      { type: 'large', count: 3 },
      { type: 'enemy', count: 1, speed: 25, shotInterval: 1.8, minSpawnTime: 6, maxSpawnTime: 10, hp: 12, size: 110, coinCount: 35 },
    ],
...

  {
    ...
    spawn: [
      ...
      { type: 'large', count: 2 },
      { type: 'enemy', count: 1, speed: 20, shotInterval: 1.5, minSpawnTime: 5, maxSpawnTime: 8, hp: 25, size: 140, coinCount: 60 },
...

  {
    ...
    spawn: [
      { type: 'large', count: 2 },
      { type: 'fragile', count: 2 },
      { type: 'enemy', count: 1, speed: 15, shotInterval: 2.0, minSpawnTime: 4, maxSpawnTime: 8, hp: 35, size: 160, coinCount: 80 },
...

  {
    ...
    spawn: [
      { type: 'bomber', count: 2 },
      { type: 'large', count: 2 },
      { type: 'enemy', count: 1, speed: 30, shotInterval: 1.0, minSpawnTime: 3, maxSpawnTime: 6, hp: 50, size: 170, coinCount: 120 },
...

  {
    ...
    spawn: [
      ...
      { type: 'bomber', count: 2 },
      { type: 'large', count: 2 },
      { type: 'enemy', count: 1, speed: 25, shotInterval: 1.2, minSpawnTime: 3, maxSpawnTime: 6, hp: 75, size: 190, coinCount: 200 },
    ],
...

  {
    ...
    spawn: [
      ...
      { type: 'stealth', count: 2 },
      { type: 'large', count: 2 },
      { type: 'enemy', count: 1, speed: 20, shotInterval: 1.0, minSpawnTime: 3, maxSpawnTime: 5, hp: 110, size: 210, coinCount: 300 },
...

  {
    ...
    spawn: [
      ...
      { type: 'enemy', count: 1, speed: 18, shotInterval: 1.5, minSpawnTime: 3, maxSpawnTime: 5, hp: 150, size: 240, coinCount: 400 },
    ],
...

  {
    ...
    spawn: [
      { type: 'large', count: 2 },
      { type: 'doppel', count: 1, speed: 90, hp: 200, size: 220, coinCount: 500 },
      { type: 'drone', count: 6 },
    ],
...

  {
    ...
    spawn: [
      ...
      { type: 'shielded', count: 2 },
      { type: 'doppel', count: 1 },
      { type: 'mothership', count: 1, hp: 250, size: 280, coinCount: 600 },
      { type: 'enemy', count: 1, speed: 16, shotInterval: 1.2, minSpawnTime: 4, maxSpawnTime: 7, hp: 180, size: 220, coinCount: 350 },
    ],
...

  {
    ...
    spawn: [
      ...
      { type: 'bomber', count: 2 },
      { type: 'drone', count: 8 },
      { type: 'mothership', count: 1, hp: 350, size: 320, coinCount: 900 },
      { type: 'enemy', count: 1, speed: 14, shotInterval: 1.0, minSpawnTime: 2, maxSpawnTime: 4, hp: 300, size: 280, coinCount: 1500 },
    ],
